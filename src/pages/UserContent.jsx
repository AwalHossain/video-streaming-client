...
const TABLE_HEAD = [
  ...
  { id: 'videoConversionTime',label:"Conversion time", alignRigh:false },
...
export default function UserContent() {
  ...
  const { isFetching, isLoading, data, } = useGetMyVideosQuery(params, { refetchOnReconnect: true, refetchOnMountOrArgChange: true, refetchOnFocus: true, });
  ...
  return (
    <>
...

                  {
                    isFetching || isLoading ? (
                      ...
                      filteredUsers.map((row) => {
                        ...
                        const { _id: id, title, createdAt, status, viewsCount, likesCount, visibility, videoConversionTime} = row;
                        ...
                        return (
                          <TableRow hover key={id} tabIndex={-1} role="checkbox" selected={selectedVideo}>
                            ...
                            <TableCell align="left">{videoConversionTime}</TableCell>
      ...
      {
        isEditing && (
          <UpdateVideoMetaData id={editingId} onClose={handleCloseEdit} />
        )
      }
    </>
  );
